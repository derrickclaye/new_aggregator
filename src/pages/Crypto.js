...
const Crypto = () => {
    ...
    useEffect(() => {
        ...
        async function fetchArticles() {
            const response = await fetch('https://us-central1-newsaggregator-f48b9.cloudfunctions.net/app/rss/crypto');
    ...
    return (
        <Box sx={{position:'relative', display:'flex', flexDirection:'column', pt:10, bgcolor:'#F0F3F8'}}>
            ...
            <Box sx={{flex:4}}>
                <Typography sx={{textAlign:'center', fontWeight:'bold', color:'#011840'}}>MAJOR CRYPTO NEWS</Typography>
